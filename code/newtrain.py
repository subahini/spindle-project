...
class EnhancedSpindle2DCNN(nn.Module):
    ...
    def __init__(self, dropout_rate: float = 0.5):
        ...
        self.conv_block1 = self._make_conv_block(1, 32, (3, 7))
        self.conv_block2 = self._make_conv_block(32, 64, (3, 5))
        self.conv_block3 = self._make_conv_block(64, 128, (3, 3))
        self.conv_block4 = self._make_conv_block(128, 256, (3, 3))
